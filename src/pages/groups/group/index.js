...
const Group = () => {
    ...
    useEffect(() => {
        // request(`${BackUrl}parent/students/by-teacher/${8}/${6}`, "GET", null, headers())
        //     .then(res => console.log(res, "res"))
        //
        // request(`${BackUrl}parent/get_list/${2}`, "GET", null, headers())
        //     .then(res => console.log(res, "res"))

        // request(`${BackUrl}parentPage/add_students/${6}`, "POST", JSON.stringify({student_ids: [12, 8]}), headers())
        //     .then(res => console.log(res))
        //
        //
        // request(`${BackUrl}parentPage/remove_students/${6}`, "POST", JSON.stringify({student_id:10}), headers())
        //     .then(res => console.log(res))
            ...
            <div className={styles.navigation}>
                ...
                >
                    <svg width="48" height="52" viewBox="0 0 48 52" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M43 51H5C2.79086 51 1 49.2091 1 47V5C1 2.79086 2.79086 1 5 1H43C45.2091 1 47 2.79086 47 5V13.4149V47C47 49.2091 45.2091 51 43 51Z"
                            stroke="#4D4D4D" stroke-width="2"/>
                ...
                >
                    <svg width="38" height="52" viewBox="0 0 38 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M4 40.5789H34C35.6569 40.5789 37 39.2358 37 37.5789V11.6946V4C37 2.34315 35.6569 1 34 1H4C2.34315 1 1 2.34314 1 4V37.5789C1 39.2358 2.34315 40.5789 4 40.5789Z"
                            stroke="#4D4D4D" stroke-width="2"/>
