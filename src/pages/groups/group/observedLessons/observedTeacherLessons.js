...
const ObservedTeacherLessons = () => {
    ...
    useEffect(() => {
        if (groupData.platform_id) {
            request(`${PlatformUrlApi}observed_group/${groupData.platform_id}`, "GET", null, headersOldToken())
                .then(res => {
    ...
    useEffect(() => {
        if (year && month) {
            request(`${PlatformUrlApi}observed_group/${groupData.platform_id}/${year}-${month}`, "GET", null, headersOldToken())
                .then(res => {
    ...
    useEffect(() => {
        ...
        if (year && month && day && groupData?.platform_id) {
            request(`${PlatformUrlApi}observed_group_info/${groupData?.platform_id}`, "POST", JSON.stringify(data), headersOldToken())
                .then(res => {
